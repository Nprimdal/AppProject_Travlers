...
public class CityListAdaptor extends RecyclerView.Adapter<CityListAdaptor.CityViewHolder> {

    private IDrinkClickedListener listener;
    private ArrayList<TripModel> trips;

    //Constructor
    public CityListAdaptor(ArrayList<TripModel> tripModels, IDrinkClickedListener listener){
    ...
    public class CityViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        IDrinkClickedListener listener;

        //References to views
        TextView txtCityName, txtCountryName;

        //Constructor: gets references to view
        public CityViewHolder(@NonNull View itemView, IDrinkClickedListener listener) {
            super(itemView);
    ...
    public interface IDrinkClickedListener {
